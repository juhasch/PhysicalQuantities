...
add_composite_unit('wk', 1., '7*d', verbosename='week')
...
add_composite_unit('c0', 299792458, 'm/s', verbosename='speed of light')
add_composite_unit('lyr', 'c0*yr', verbosename='light year')

add_composite_unit('eps0', 28.854188e-12, 'F/m', verbosename='vacuum permittivity')
